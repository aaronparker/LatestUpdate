#
# Module manifest for module 'LatestUpdate'
#
...
FunctionsToExport = @('Get-LatestFlash', 'Get-LatestServicingStack', 'Get-LatestUpdate', 
               'Import-LatestUpdate', 'Save-LatestUpdate', 'Get-LatestNETFramework')
